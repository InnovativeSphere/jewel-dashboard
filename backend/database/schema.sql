...
--
-- Host: localhost    Database: jewel_foundation_database
-- ------------------------------------------------------
...
CREATE TABLE `donations` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `donations_ibfk_1` (`project_id`),
  CONSTRAINT `donations_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `project_people` (
  ...
  PRIMARY KEY (`id`),
  KEY `project_people_ibfk_1` (`project_id`),
  KEY `project_people_ibfk_2` (`person_id`),
  CONSTRAINT `project_people_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `project_people_ibfk_2` FOREIGN KEY (`person_id`) REFERENCES `people` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2026-02-16 12:51:05
